...
optdepends=(
  'perl: to use corresponding binding'
...
sha256sums=(
  'bd37614137d7a8dc523359648eb2a81631a34fd91a82ed5581916a52c08433f4'
)

prepare() {
  cd \
    "${pkgname}-${pkgver}"
  # fix FS#28521 make ruby install
  # to vendor_ruby instead of site_ruby
  sed \
   -e \
    's/$(RUBY) ${abs_srcdir}\/ruby\/extconf.rb/& --vendor/' \
    -i \
